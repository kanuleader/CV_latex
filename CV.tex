...
\begin{rSubsection}{KAIST, South Korea}{September 2014 - August 2016}{M.S Candidate}{}
 \item Face detection and tracking algorithms were used to design systems that automatically detect human faces in surveillance environments. In particular, deep learning-based face detector was ported to the C level and integrated into the system for privacy protection in large-scale surveillance video.
